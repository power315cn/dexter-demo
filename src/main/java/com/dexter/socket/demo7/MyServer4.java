 ...
 * @ClassName:	MyServer4 
 * @Description:
 * 下面的示例演示了客户端向服务器端发送一个文件，服务器作为响应给客户端会发一个文件。
 * 这里准备两个文件
 * E:/test/server_send.log和E:/test/client.send.log文件，在测试完毕后在客户端和
 * 服务器相同目录下会多出两个文件
 * E:/test/server_receive.log和E:/test/client.receive.log文件。
 * @author:	dexter
 * @date:	2016年6月3日 下午3:38:30 
 *  
 */
